    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="/zheng/index.php/Admin/Index/rel" method="post">
            ...
            <form name="myform" id="myform" action="/zheng/index.php/Admin/Index/sort" method="post">
                ...
                <div class="result-title">
                    <div class="result-list">
                        <i class="icon-font"></i>新增书籍
                        <a href="/zheng/index.php/Admin/Index/excel"><i class="icon-font"></i>导出Excel</a>(*学生推荐管理员没有权限添加书本)
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="link-update" href="/zheng/index.php/Admin/Index/edit/id/<?php echo ($vo["id"]); ?>"><i class="icon-font"></i>修改</a>|
                                <a class="link-del"  onclick="return confirm('确定删除么')" href="/zheng/index.php/Admin/Index/del/id/<?php echo ($vo["id"]); ?>"><i class="icon-font"></i>删除</a>
                            </td>
