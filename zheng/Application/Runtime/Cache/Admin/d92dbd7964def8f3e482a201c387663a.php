...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" enctype="multipart/form-data" action="/zheng/index.php/Admin/Index/download" method="post">
            欢迎你导出excel<input type="submit" value="导出excel">
            </form><br><hr>
            <!-- <form name="myform" id="myform" action="/zheng/index.php/Admin/Index/excel" method="post">
