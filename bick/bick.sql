...
CREATE TABLE IF NOT EXISTS `bk_admin` (
  ...
  `addtime` varchar(30) NOT NULL COMMENT '注册时间',
  PRIMARY KEY (`id`)
...
INSERT INTO `bk_admin` (`id`, `name`, `password`, `addtime`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', '1517744148'),
(12, '222222', 'e3ceb5881a0a1fdaad01296d7554868d', ''),
...
(19, '测试轮播1', '', '', '', '/bick/public\\uploads/20170107\\71e2a41f3682d15b3d445c11fb1787cd.jpg', '<p>测试录播1测试录播1测试录播1测试录播1测试录播1</p>', 3, 0, 1, 1483793251, 26),
...
(36, 'test', 1, 'test', 'test', '', 0, 0, 27, 50),
(44, 'test1', 1, 'test1', 'test1', '', 0, 0, 36, 50),
(45, 'test2', 1, 'test1', 'test1', '', 0, 0, 36, 50);
...
(2, '36011', '', 'http://www.360.com', 50),
(3, '新浪', '新浪新浪新浪', 'http://www.sina.com.cn', 1),
(11, '淘宝', '淘宝', 'www.taobao.com', 50),
(12, '2234343', '332443', '3332', 50),
(13, 'c', 'c', 'c', 3),
(15, 'test', '222', 'test22', 50);
