<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\phpStudy\WWW\youme\public/../application/admin\view\admin\lst.html";i:1469329395;s:70:"D:\phpStudy\WWW\youme\public/../application/admin\view\Public\top.html";i:1469355121;s:71:"D:\phpStudy\WWW\youme\public/../application/admin\view\Public\left.html";i:1469328218;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo url('add'); ?>"><i class="icon-font"></i>新增管理员</a>
                    </div>
                </div>
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if($vo['id'] != 1): ?>
                                <a class="link-del" onclick="return confirm('你确定要删除该管理员吗？');" href="<?php echo url('del',array('id'=>$vo['id'])); ?>">删除</a>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </table>
                    <div class="list-page"><?php echo $adminres->render(); ?></div>
                </div>
            </form>
        </div>
    </div>
