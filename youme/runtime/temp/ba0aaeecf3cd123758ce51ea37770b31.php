<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\phpStudy\WWW\youme\public/../application/index\view\index\index.html";i:1469528908;s:73:"D:\phpStudy\WWW\youme\public/../application/index\view\Public\header.html";i:1469416464;s:73:"D:\phpStudy\WWW\youme\public/../application/index\view\Public\footer.html";i:1469088902;}*/ ?>
...
<?php endforeach; endif; else: echo "" ;endif; ?>
		...
		<div class="post multi-post cate2 auth1">
			...
			<?php if($vo['pic'] != ''): ?>
			<p style="text-indent: 0em;"><a title="<?php echo $vo['title']; ?>" target="_self" href="<?php echo url('article/index',array('artid'=>$vo['id'])); ?>"><img src="__PUBLIC__/<?php echo $vo['pic']; ?>" title="<?php echo $vo['title']; ?>" alt="<?php echo $vo['title']; ?>"/></a></p>
			<?php endif; ?>
			</div>

			<h5 class="post-tags">Tags: <span class="tags"><?php
			...
			<h6 class="post-footer">
				发布:圈圈 | 分类:<?php echo $vo['catename']; ?> | 评论:6 | 浏览:<span id="spn75"><?php echo $vo['click']; ?></span>
				 | <a href="<?php echo url('article/index',array('artid'=>$vo['id'])); ?>">阅读全文 > </a>
			</h6>
		</div>
		<?php endforeach; endif; else: echo "" ;endif; ?>
...
<dd class="function_c">
<div><div style="padding:0.5em 0 0.5em 1em;">
