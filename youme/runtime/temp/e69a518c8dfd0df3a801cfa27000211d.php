<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"F:\phpStudy\WWW\youme\public/../application/index\view\tags\lst.html";i:1469430546;s:73:"F:\phpStudy\WWW\youme\public/../application/index\view\Public\header.html";i:1469416464;s:73:"F:\phpStudy\WWW\youme\public/../application/index\view\Public\footer.html";i:1469088902;}*/ ?>
			...
			<?php if(is_array($artres) || $artres instanceof \think\Collection): $i = 0; $__LIST__ = $artres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
				<div class="post multi-post cate2 auth1">
					...
					<h6 class="post-footer">
						发布:圈圈 | 分类:<?php echo $vo['catename']; ?> | 评论:6 | 浏览:<?php echo $vo['click']; ?> | <a href="<?php echo url('Article/index',array('artid'=>$vo['id'])); ?>">阅读全文 > </a>
					</h6>
				</div>
			<?php endforeach; endif; else: echo "" ;endif; ?>
