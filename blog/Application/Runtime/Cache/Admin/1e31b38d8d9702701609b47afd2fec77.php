                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="内容"><a target="_blank" href="#" title="内容"><?php echo ($vo["catename"]); ?></a> … <!-- <a class="link-update" href="/blog/index.php/Admin/Cate/edit/id/<?php echo ($vo["id"]); ?>">查看内容</a> -->
                            <a href ='javascript:;' class='show' data='<?php echo ($vo["id"]); ?>' data-title='<?php echo ($vo["catename"]); ?>'>查看</a>
                            </td>
                            
                            <td>
                                <a class="link-update" href="/blog/index.php/Admin/Cate/edit/id/<?php echo ($vo["id"]); ?>">修改</a>|
                                <a class="link-del" onclick="return confirm('确定删除么')" href="/blog/index.php/Admin/Cate/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
...
$(function(){
    ...
    $('.show').on('click',function(){
        ...
        layer.open({
            ...
            shade: 0.5,   //背景透明
            area: ['560px', '90%'],
            content: '/blog/index.php/Admin/Cate/showContent/id/' + id //iframe的url
        }); 
    });
});
</script>
