                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                     <input id="pic" name="pic" size="50" value="" type="file"> <?php if($articler["pic"] == '' ): ?>无缩略图
<?php else: ?> <img src="/blog<?php echo ($articler["pic"]); ?>" height="50"><?php endif; ?>
                                </td>
                            </tr>
                           <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                      <textarea name="content" id="content" style="width: 700px; height: 200px;"><?php echo ($articler["content"]); ?></textarea>
