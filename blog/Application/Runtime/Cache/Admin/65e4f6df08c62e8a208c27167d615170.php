                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="<?php echo ($vo["title"]); ?>"><a target="_blank" href="#" title="<?php echo ($vo["title"]); ?>"><?php echo ($vo["title"]); ?></a> … <!-- <a class="link-update" href="/blog/index.php/Admin/Link/edit/id/<?php echo ($vo["id"]); ?>">查看内容</a> -->
                            </td>
                            ...
                            <td>
                                ...
                                <a class="link-del" onclick="return confirm('确定删除么')" href="/blog/index.php/Admin/Link/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
