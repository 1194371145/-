...
<div class="admin_login_wrap">
    ...
    <div class="adming_login_border">
        <div class="admin_input">
            <form action="<?php echo U('checkLogin');?>" action="" method="post">
                <ul class="admin_items">
                    ...
                    <li>
                        ...
                        <input type="password" name="captcha" value="" id="verfiy" size="15" class="admin_input_style" /><img src="/blog/index.php/Admin/Login/captcha" onclick="this.src='/blog/index.php/Admin/Login/captcha/t/'+Math.random()">
                    </li>
                    <li>
