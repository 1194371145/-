...
<div class="table-operate ue-clear">
	<a href="/app/index.php/Admin/Doc/add" class="add">添加</a>
	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
               ...
               <!-- vol.title|msubstr=0,8-->
				<td class="file"><?php echo ($vol["filename"]); if(!empty($vol["filename"])): ?>【<a href='/app/index.php/Admin/Doc/download/id/<?php echo ($vol["id"]); ?>'>下载</a>】<?php endif; ?></td>
                <td class="content"><?php echo ($vol["author"]); ?></td>
                <td class="addtime"><?php echo (date('Y-m-d H:i:s',$vol["addtime"])); ?></td>
                <td class="operate">
                	<a href ='javascript:;' class='show' data='<?php echo ($vol["id"]); ?>' data-title='<?php echo ($vol["title"]); ?>'>查看</a> <a href ='/app/index.php/Admin/Doc/edit/id/<?php echo ($vol["id"]); ?>' >编辑</a> 
                </td>
...
$(function(){
    ...
    $('.show').on('click',function(){
        ...
        layer.open({
            ...
            shade: 0,   //背景透明
            area: ['560px', '90%'],
            content: '/app/index.php/Admin/Doc/showContent/id/' + id //iframe的url
        }); 
    });
});
</script>
