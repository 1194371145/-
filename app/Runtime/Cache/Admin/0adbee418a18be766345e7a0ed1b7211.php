...
<div class="table-operate ue-clear">
	<a href="/app/index.php/Admin/Knowledge/add" class="add">添加</a>
	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td class="file"><img src="<?php echo ($vo["thumb"]); ?>"/><?php if(!empty($vo["picture"])): ?>【<a href='/app/index.php/Admin/Knowledge/download/id/<?php echo ($vo["id"]); ?>'>下载</a>】<?php endif; ?></td>
