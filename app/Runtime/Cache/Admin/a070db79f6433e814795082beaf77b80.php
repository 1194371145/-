	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td class="file"><?php echo ($vo["filename"]); if($vo["hasfile"] == 1): ?>【<a href="/app/index.php/Admin/Email/download/id/<?php echo ($vo["id"]); ?>">下载</a>】<?php endif; ?></td>
                <td class="content"><?php echo ($vo["content"]); ?></td>
                <td class="addtime"><?php echo (date('Y-m-d H:i:s',$vo["addtime"])); ?></td>
                <td class="status"><?php if($vo["isread"] == 0): ?><span style="color: red;">未读</span><?php else: ?><span style="color:gray;">已读</span><?php endif; ?></td>
                <td class="operate">
