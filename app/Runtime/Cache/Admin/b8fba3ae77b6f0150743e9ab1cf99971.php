...
<head>
	...
	<link rel="stylesheet" href="/app/Public/Admin/css/login.css" />
			...
			<div class="login1">
                ...
                <div class="login-input">
                    ...
                    <p class="yzm ue-clear">
                    	<label>验证码</label>
                        <!-- http://localhost/app/index.php/admin/public/captcha -->
                        <input type="text" name="captcha" maxlength="4" />
                        <cite><img style="margin:2px; " src="/app/index.php/Admin/Public/captcha" onclick="this.src='/app/index.php/Admin/Public/captcha/t/'+Math.random()"></cite>
                    </p>
                </div>
