    ...
    <table>
        ...
        <tbody>
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="name"><font color="green"><?php echo (str_repeat('&emsp;',$vol["level"]*2)); echo ($vol["name"]); ?></td>
                <td class="process"><?php if($vol["pid"] == 0): ?>顶级部门<?php else: ?><font color="red"><?php echo ($vol["deptname"]); ?>|/0.0\|</font><?php endif; ?></font></td>
                <td class="node"><?php echo ($vol["sort"]); ?></td>
                <td class="time"><?php echo ($vol["remark"]); ?></td>
                <td class="operate">
                <input type="checkbox" value="<?php echo ($vol["id"]); ?>"/>
                <a href="/app/index.php/Admin/Dept/edit/id/<?php echo ($vol["id"]); ?>"> 编辑</a><?php echo ($vol["pid"]); ?>
                </td>
...
<script type="text/javascript" src="/app/Public/Admin/js/jquery.pagination.js"></script>
...
$(function(){
    ...
    $('.del').on('click',function(){
        ...
        //带着参数跳转到del方法
        window.location.href = '/app/index.php/Admin/Dept/del/id/' + id;
    });
});
</script>
</html>