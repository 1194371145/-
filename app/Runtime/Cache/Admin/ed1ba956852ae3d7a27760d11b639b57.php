...
<div class="table-operate ue-clear">
    ...
    <a href="/app/index.php/Admin/User/charts" class="count">统计</a>
	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="operate"><a href="/app/index.php/Admin/User/edit/id/<?php echo ($vol["id"]); ?>">编辑</a>|<input type="checkbox" value="<?php echo ($vol["id"]); ?>"/>
                <a href="/app/index.php/Admin/User/del/id/<?php echo ($vol["id"]); ?>">删除</a></td>
...
$(function(){
    ...
    $('.del').on('click',function(){
        ...
        //带着参数跳转到del方法
        window.location.href = '/app/index.php/Admin/User/del/id/' + id;
    });
});
</script>
</html>