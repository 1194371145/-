...
<div class="table-box">
	<table>
        ...
        <tbody>
        <?php if(is_array($data)): foreach($data as $key=>$): ?><tr>
               <td class="num">{vo1.id}</td>
                <td class="name">{vo1.name}</td>
                <td class="process">{vo1.pid}</td>
                <td class="node">{vo1.sort}</td>
                <td class="time">{vo1.remark}</td>
